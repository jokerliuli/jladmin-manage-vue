  ...
  <div class="app-container" >
    <el-form v-loading="loading" ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 90%; margin-left:50px;">
      ...
      <el-form-item label="排序" prop="sort">
        <el-tooltip class="item" effect="dark" content="默认按照创建时间倒序，如需订制位置，修改从1开始" placement="top">
...
import { update, getOne } from '@/api/news'
...
export default {
  ...
  methods: {
    ...
    backToIndex() {
      this.$router.push({ path: '/information/news' })
    },
    createData() {
